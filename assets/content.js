...
window.BAR_REVIEWS = [
  {
    ...
    notes: "这里不是专业品酒记录，更像一张先占位的夜间地图。真正去过的店会慢慢补上：喝了什么，坐在哪里，灯光是不是舒服，适不适合聊天，适不适合把自己暂时放下。",
    recommended: ["靠吧台的位置", "酸一点的酒", "晚上九点后"],
  ...
  },
  {
    ...
    notes: "需要一个不太正式的地方，把白天的课、实验和消息先放到旁边。咖啡好不好喝不是唯一重点，桌面高度、插座、旁边人的音量，反而更影响一个晚上能不能安静下来。",
  ...
  },
  {
    ...
    oneLine: "不一定好喝，但很适合把晚上拖长。",
    notes: "有些酒不是为了被郑重其事地评价，而是为了在回宿舍路上给自己一个短暂借口。它可能太甜，也可能太普通，但在某些晚上，普通本身就是它的用途。",
    recommended: ["低度罐装酒", "夜路", "不用开会的第二天"],
